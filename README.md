...
* `predictions` - предсказания участков Z-DNA для 5 выбранных геномов
## 1. Таблица аннотированных генов
## 2. Гистограмма значений zh-score
Попытка отобразить распредление значений zh-score по всему геному. Зеленым обозначены участки Z-DNA, размер столбца описывает величину ah-score. Красным - аннотированные геномы.  
...
## 3. Распределение участнов Z-DNA
